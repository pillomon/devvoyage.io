export const SAMPLE_1 = `const getItemPerRow = () => {
...
const campaignRows = rearrangeRows(flatData, getItemPerRow);
`;
export const SAMPLE_2 = `<Virtuoso
  useWindowScroll
  endReached={onFetch}
  data={campaignRows}
...
/>`
export const SAMPLE_3 = `'use client';
