...
import {
  ...
  SAMPLE_4,
  SAMPLE_5,
} from '@/constants/content/blog/20240520.ts';
...
<Code code={SAMPLE_1} lang="dockerfile" />
...
<Code code={SAMPLE_2} lang="dockerfile" />
...
<Code code={SAMPLE_3} lang="dockerfile" />

## Builder stage

<Code code={SAMPLE_4} lang="dockerfile" />
...
<Code code={SAMPLE_5} lang="dockerfile" />
...
Vercel에서 제공하는 기본 Dockerfile을 의미를 해석해보았는데, 이글을 보고 도움이 되었으면 좋겠습니다. 저의 경우 현업에서 별도로 서버구성 담당이 없기에 제가 직접 Docker환경을 구축하였으며, 위의 Dockerfile을 base로 sharp를 다운로드하는 로직 추가 또는 pm2 설정을 통한 무중단 서비스 제공 등 저희 프로젝트에 맞게 더 나아가 소프트웨어 운영에 도움이 되는 방향으로 수정하여 사용중입니다.!import { SAMPLE_2 } from '../../constants/content/blog/20240520';import { SAMPLE_3 } from '../../constants/content/blog/20240520';
